 ...
 */
final class Version20230428180816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artiste DROP id_artiste');
        $this->addSql('ALTER TABLE artiste ADD PRIMARY KEY (login)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artiste ADD id_artiste INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_artiste)');
